/** @file
  ...
  L4RClientTransaction.h - The Transaction class for L4R*
...
{
public:
  using super_type = BasicProxyClientTransaction;

  L4RClientTransaction() {}
  ...
  // L4RClientTransaction class as necessary.  The super::destroy() clears the
