...
class BasicProxyClientTransaction : public VConnection
{
public:
  BasicProxyClientTransaction();
  ...
  virtual void attach_server_session(VConnection *ssession, bool transaction_done = true);
...
protected:
  BasicProxyClientSession *parent;
  VConnection *current_reader;
  IOBufferReader *sm_reader;
