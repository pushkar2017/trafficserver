...
//----------------------------------------------------------------------------
const char *
TunnelDebugNames::get_server_state_name(HttpTransact::ServerState_t state)
{
  switch (state) {
...
//////////////////////////////////////////////////////////////////
//
//  TunnelDebugNames::get_method_name()
//
//////////////////////////////////////////////////////////////////
const char *
TunnelDebugNames::get_method_name(const char *method)
{
...
//////////////////////////////////////////////////////////////////
//
//  TunnelDebugNames::get_event_name()
//
//////////////////////////////////////////////////////////////////
const char *
TunnelDebugNames::get_event_name(int event)
{
  switch (event) {
  /////////////////////////
  // VCONNECTION  EVENTS //
...
//////////////////////////////////////////////////////////////////
//
//  TunnelDebugNames::get_action_name()
//
//////////////////////////////////////////////////////////////////
const char *
TunnelDebugNames::get_action_name(HttpTransact::StateMachineAction_t e)
{
  switch (e) {
...
//////////////////////////////////////////////////////////////////
//
//  TunnelDebugNames::get_cache_action_name()
//
//////////////////////////////////////////////////////////////////
const char *
TunnelDebugNames::get_cache_action_name(HttpTransact::CacheAction_t t)
{
  switch (t) {
...
//////////////////////////////////////////////////////////////////
//
//  TunnelDebugNames::get_api_hook_name()
//
//////////////////////////////////////////////////////////////////
const char *
TunnelDebugNames::get_api_hook_name(TSHttpHookID t)
{
  switch (t) {
